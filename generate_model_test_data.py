...
for case_num in case_num_list:
    ...
    wb = jsonlines.open("generate_data/test/generate_test_" + str(case_num) + ".jsonl", mode = "w")

    with open("generate_data/test/generate_test_" + str(case_num) + ".txt", encoding="utf-8") as f:
        data = f.read()
