...
file_path_list = ["generate_data/train/generate_train_", "fix_data/train/fix_train_", "verify_data/train/verify_train_"]
case_num_list = [10, 25, 50, 100, 250, 500, 1000, 2500, 5000, 10000]
