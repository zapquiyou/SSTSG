...
for num_case_model_train in num_case_model_train_list:
    ...
    fix_result_json = jsonlines.open("mix_data/test/mix_test_fix_" + str(num_case_model_train) + "_result.jsonl", mode = "r")
    ...
    with open("mix_data/test/mix_fix_check_" + str(num_case_model_train) + ".json", "w", encoding='utf-8') as f:
