...
for num_temperature in num_temperature_list:
    ...
    for times in range(10):
        correct_result_json = jsonlines.open("mix_data/test/fix_test_1000.jsonl", mode = "r")
        fix_result_json = jsonlines.open("mix_data/test/test_mix_fix_15000_temperature_" + str(num_temperature) + "_" + str(times) + "_result.jsonl", mode = "r")
    ...
    with open("mix_data/test/fix_test_sampling_" + str(num_temperature) + "_check.json", "w", encoding='utf-8') as f:
