...
for num_case_model_train in num_case_model_train_list:
    correct_result_json = jsonlines.open("verify_data/test/verify_test_1000.jsonl", mode = "r")
    verify_result_json = jsonlines.open("verify_data/test/verify_test_" + str(num_case_model_train) + "_result.jsonl", mode = "r")
    ...
    with open("verify_data/test/verify_check_" + str(num_case_model_train) + ".json", "w", encoding='utf-8') as f:
