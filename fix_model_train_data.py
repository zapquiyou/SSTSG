...
for num_case in num_case_list:
    formal_case_file = open("fix_data/train/fix_train_" + str(num_case) + ".txt", "r", encoding="utf-8")
    formal_case = formal_case_file.read()
    cases = formal_case.split("--------Test_Cases--------:\n")

    prompt_file = jsonlines.open("fix_data/train/fix_train_" + str(num_case) + ".jsonl", mode = "w")
