...
for num_temperature in num_temperature_list:
    ...
    for times in range(10):
        ...
        verify_result_json = jsonlines.open("mix_data/test/test_mix_verify_15000_temperature_" + str(num_temperature) + "_" + str(times) + "_result.jsonl", mode = "r")
    ...
    with open("mix_data/test/test_verify_sampling_" + str(num_temperature) + "_check.json", "w", encoding='utf-8') as f:
