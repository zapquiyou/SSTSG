...
for num_case in num_case_list:
    formal_case_file = open("verify_data/test/verify_test_" + str(num_case) + ".txt", "r", encoding="utf-8")
    formal_case = formal_case_file.read()
    cases = formal_case.split("--------Test_Cases--------:\n")

    prompt_file = jsonlines.open("verify_data/test/verify_test_" + str(num_case) + ".jsonl", mode = "w")
