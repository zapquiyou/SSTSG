...
for num_case_model_train in num_case_model_train_list:
    correct_result_json = jsonlines.open("generate_data/test/generate_test_1000.jsonl", mode = "r")
    generate_result_json = jsonlines.open("generate_data/test/generate_test_" + str(num_case_model_train) + "_result.jsonl", mode = "r")
    ...
    with open("generate_data/test/generate_check_" + str(num_case_model_train) + ".json", "w", encoding='utf-8') as f:
