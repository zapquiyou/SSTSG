...
num_test_case_list = [300, 750, 1500, 3000, 7500, 15000, 30000, 75000, 150000, 300000]
...
for num_test_case in num_test_case_list:
    ...
    wf = jsonlines.open("mix_data/test/mix_test_fix_" + str(num_test_case) + "_result.jsonl", mode = "w")
