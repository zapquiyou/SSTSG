...
for num_test_case in num_test_case_list:
    ...
    for loop in range(10):
        for temperature in temperature_list:
            cj = jsonlines.open("mix_data/test/verify_test_1000.jsonl", mode = "r")
            wf = jsonlines.open("mix_data/test/test_mix_verify_" + str(num_test_case) + "_temperature_" + str(temperature) + "_" + str(loop) + "_result.jsonl", mode = "w")
